...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  beforeMount: function beforeMount() {
    var vm = this;
    Nova.request().get('/nova-vendor/calendar/users').then(function (response) {
      console.log(response);
      vm.calendarOptions.events = response.data.users.map(function (event) {
        return {
          title: event.name,
          date: event.date
        };
...
/* harmony import */ var _var_www_html_nova_components_Calendar_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkhugochenr_calendar"] = self["webpackChunkhugochenr_calendar"] || [];
